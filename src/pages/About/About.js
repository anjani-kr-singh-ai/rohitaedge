        ...
        <div className="container">
          ...
          <div className="about-story reveal">
            <div className="about-story-text">
              ...
              <p>RohithaEdge Enterprises Private Limited is a new-age IT infrastructure company based in Kurnool, Andhra Pradesh, built to bridge the technology gap for businesses across the region. We bring genuine products, transparent pricing and dedicated after-sales support to every project we take on.</p>
            ...
            <div className="about-visual-box">
              <div className="about-visual-image">
                <img src="/network-solutions-slider.jpg" alt="RohithaEdge Enterprises Private Limited infrastructure" loading="lazy" />
              </div>
